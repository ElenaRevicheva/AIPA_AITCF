# Panama + LATAM Target Prospects — where Elena's portfolio services are in demand
...
> (usually) WhatsApp — exactly the profile the play converts. **Dedupe in HubSpot before creating.**
>
...
| **Companion-grade personal AI** | Premium / product-lab proof (tutors, coaches) — use as credibility, not first SKU. |

**The pattern that converts (validated):** bilingual/international clientele + high ticket + discovery happens in AI search + bookings/leads close on WhatsApp. That's why Tier A is medical tourism, relocation/immigration, and tourism — then expand to CR / CO / MX with the same pattern.
...
## Tier C — solid local-money (quote/lead-driven, Panama)

Validated shape: **Eurostone**, **AIRCO / SINOTRUK**, **Nomad Constructions**. Quote-driven → WhatsApp agent + AI visibility.
...
| Restaurants / rooftop / catering | (mine) | Reservations via WA agent + AI video — only if site + WA exist |

---

## Tier D — Neighboring countries (same pattern, remote-ready)

Same iron filter: **intl patients/travelers ask AI → close on WhatsApp → bilingual site**. Stage only after Panama Tier A shortlist pressure eases (or when a warm intro appears).

### D1. Costa Rica — medical tourism + Pacific charters
...
**Directories / aggregators (mine clinics & hotels — do not stage the aggregator):**
...
- `Medellín cirugía plástica English WhatsApp`
- `Cancún dental tourism English WhatsApp`
