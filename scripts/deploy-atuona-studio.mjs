...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .tag{color:var(--red);font-size:12px;letter-spacing:.45em;margin-top:10px;font-family:'Courier New',monospace}
  .sub{color:#888;font-size:13px;margin-top:8px;letter-spacing:.04em}
